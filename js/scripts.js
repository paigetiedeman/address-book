...
$(document).ready(function() {
  ...
  $("form#new-contact").submit(function(event) {
    ...
    $("input#new-state").val("");
    $("input#new-zip").val("");
    var newContact = new Contact(inputtedFirstName, inputtedLastName, inputtedPhoneNumber, inputtedEmail, inputtedAddress, inputtedAddress2, inputtedCity, inputtedState, inputtedZip);
